...
const BlockInput = (props,myref) => {
  ...
  return (
    <div style={{position:'relative',...props.style}}>
      <Input id={props.id} className={props.className} style={{resize:'none',...props.textStyle}}
        ref={inputRef}
        ...
        onFocus={(e)=>{hideHint();if(props.onFocus)props.onFocus(e)}}
...
export default React.forwardRef(BlockInput);
